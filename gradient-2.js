...
function normalizeColor(hexCode) {
  ...
  class Gradient {
    ...
    */
    ...
    initGradientColors() {
      // Couleurs : 6 nuances de noir à partir de #1E1E1E
      this.sectionColors = [
        '0x1E1E1E', // Noir de base
        '0x252525', // Légèrement plus clair
        '0x2C2C2C', // Encore plus clair
        '0x333333', // Gris foncé
        '0x191919', // Légèrement plus foncé
        '0x121212'  // Encore plus foncé
      ].map(normalizeColor);
